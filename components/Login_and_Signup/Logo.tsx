            ...
            >
                <g id="XMLID_71_">
                    <path
                        id="XMLID_72_"
                        className="st0"
                        d="M67.4,338.9c-34.9,0-61-24.3-61-59.8c0-36.3,26.9-59.5,61.4-59.5c15.8,0,33,5.8,42.4,16.6
                    ...
                    <path
                        id="XMLID_74_"
                        className="st0"
                        d="M197.9,335.8l-8.8-22.2h-43.8l-8.3,22.2h-29.8l47.5-113.3h26.6l47,113.3H197.9z M167.5,252.8
                    l-14.4,38.9h28.5L167.5,252.8z"
                    />
                    <path
                        id="XMLID_77_"
                        className="st0"
                        d="M298.4,335.8l-24.5-45h-9.3v45h-26.9V222.5H281c21.8,0,43.4,8.3,43.4,34.2
                    ...
                    <path
                        id="XMLID_82_"
                        className="st1"
                        d="M438.2,222.5h37.6c28.3,0,59.5,18.9,59.5,56.6s-31.2,56.6-59.5,56.6h-37.6V222.5z M449.8,325.6
                    h22.9c34.1,0,50.6-23,50.6-46.4s-16.5-46.4-50.6-46.4h-22.9V325.6z"
                    />
                    <path
                        id="XMLID_85_"
                        className="st1"
                        d="M570.9,335.8h-11.5V222.5h33.3c22.4,0,38.7,8.2,38.7,30.2c0,16.8-12.5,27.4-29,29.1l33.1,53.9
                    h-14.1l-31.4-53h-19.2V335.8z M570.9,272.9h20c18.4,0,29-6.7,29-20.2c0-14.9-11.4-20.3-28.5-20.3h-20.5V272.9z"
                    />
                    <path
                        id="XMLID_88_"
                        className="st1"
                        d="M708.2,338.7c-33.8,0-59-25.1-59-59.5c0-34.4,25.3-59.5,59-59.5s59,25.1,59,59.5
                    ...
                    <path
                        id="XMLID_91_"
                        className="st1"
                        d="M791.2,222.5h32c23,0,38.2,9.9,38.2,30.2s-15.5,30.4-38.6,30.4h-20.2v52.6h-11.5V222.5z
                ...
                <path
                    id="XMLID_8_"
                    className="st0"
                    d="M357.2,93.7l49.5,85.7h-35.2c-1.8,0-3.5-1-4.4-2.5l-46.6-80.6c-0.9-1.6-0.9-3.5,0-5.1L367,10.7
                c0.9-1.6,2.6-2.3,4.4-2.3h35L357.2,93.7z"
                />
                <path
                    id="XMLID_9_"
                    className="st0"
                    d="M414.1,94.8l47.2,84.6h-38.2l-49.7-85.9l49.2-85.1h39c0.4,0,0.9-0.2,1.3-0.1l-48.7,81.2
                C413.3,91.2,413.2,93.1,414.1,94.8z"
                />
                <path
                    id="XMLID_14_"
                    className="st2"
                    d="M515.2,89.8l-40.4-70l-25.5,42.6l18.1,31.2c1.4,2.3,1.4,5.2,0,7.5l-16.5,28.6l23.2,41.5
