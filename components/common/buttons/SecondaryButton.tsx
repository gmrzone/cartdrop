...
const SecondaryButton: NextPage<SecondaryProps> = ({ text, icon, loading, disable }) => {
    return (
        <button className={`w-auto py-3 px-6 font-semibold rounded-full border-2 transition-colors duration-300 ${disable ? "bg-gray-400 border-none cursor-not-allowed bg-opacity-75" : "border-main"}`}>
