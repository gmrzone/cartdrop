...
const ExtraButton: NextPage<ExtraProps> = ({ text, icon, loading, disable }) => {
    return (
        <button className={`w-auto py-3 px-5 font-semibold rounded transition-colors duration-300 ${disable ? "bg-gray-600 cursor-not-allowed bg-opacity-75" : "bg-secondary hover:bg-main"}`}>
