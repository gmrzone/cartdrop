...
const FilterHead: NextPage<FilterHeadProps> = ({ openFilterSilder }) => {
    ...
    return (
        <div className="drop-shadow px-4 py-2 flex justify-between items-center bg-main relative z-50">
            <div
                className="flex space-x-2 mobile-sm:space-x-3 ipad:space-x-4 items-center cursor-pointer"
