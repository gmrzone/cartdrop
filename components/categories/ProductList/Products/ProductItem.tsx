...
const ProductItem: NextPage<ProductItemProps> = ({ productDetail }) => {
    ...
    return (
        <Link href={`product-detail/${productDetail.product.slug}/${productDetail.uuid}/${productDetail.pid}/`}>
            <a className="p-6 border-solid border-gray-200 border cursor-pointer rounded-md ipad:mx-3 my-4 block">
